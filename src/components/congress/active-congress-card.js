...
import {fetchProPosts, addEmptyProEntry, editProPost, addProPost, deleteProPost, congressSetEdit, congressSetExpanded, uploadProImage, congressSetImgUrl} from '../../actions/home/congress-actions';
...
const mapStateToProps = state => ({
    ...
    loading: state.congressReducers.activeProPostLoading,
    imgUrl: state.congressReducers.imgUrl,
    loggedIn: state.auth.currentUser !== null,
    activeProPost: state.congressReducers.activeProPost
  });
